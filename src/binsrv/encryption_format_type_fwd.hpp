...
#ifndef BINSRV_ENCRYPTION_FORMAT_TYPE_FWD_HPP
#define BINSRV_ENCRYPTION_FORMAT_TYPE_FWD_HPP
...
template <>
struct util::is_string_convertible<binsrv::encryption_format_type>
    : std::true_type {};

#endif // BINSRV_ENCRYPTION_FORMAT_TYPE_FWD_HPP

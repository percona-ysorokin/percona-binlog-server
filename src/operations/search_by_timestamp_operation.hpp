...
#ifndef OPERATIONS_SEARCH_BY_TIMESTAMP_OPERATION_HPP
#define OPERATIONS_SEARCH_BY_TIMESTAMP_OPERATION_HPP
...
template <>
class generic_operation<mode_type::search_by_timestamp>
...
private:
  ...
  [[nodiscard]] std::string_view get_timestamp() const noexcept {
...
#endif // OPERATIONS_SEARCH_BY_TIMESTAMP_OPERATION_HPP

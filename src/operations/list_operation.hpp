...
#ifndef OPERATIONS_LIST_OPERATION_HPP
#define OPERATIONS_LIST_OPERATION_HPP
...
template <> class generic_operation<mode_type::list> : public basic_operation {
public:
...
#endif // OPERATIONS_LIST_OPERATION_HPP

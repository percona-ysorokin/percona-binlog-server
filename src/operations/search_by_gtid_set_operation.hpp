...
#ifndef OPERATIONS_SEARCH_BY_GTID_SET_OPERATION_HPP
#define OPERATIONS_SEARCH_BY_GTID_SET_OPERATION_HPP
...
template <>
class generic_operation<mode_type::search_by_gtid_set>
...
private:
  ...
  [[nodiscard]] std::string_view get_gtid_set() const noexcept {
...
#endif // OPERATIONS_SEARCH_BY_GTID_SET_OPERATION_HPP
